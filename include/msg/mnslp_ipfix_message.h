 ...
 *  
 */
class mnslp_ipfix_message : public mnslp_mspec_object
{
   ...
   protected:
	    ...
	    */
	   void mnslp_ipfix_parse_hdr( uchar *mes, int offset );
   ...
   public:	
	    ...
	    */
	   explicit mnslp_ipfix_message( int sourceid, int ipfix_version, bool _encode_network = true);
	    ...
	    */
	   explicit mnslp_ipfix_message(uchar * param, size_t message_length, bool _decode_network);
	   
	   explicit mnslp_ipfix_message(const mnslp_ipfix_message &rhs);
	   
	   /**
	    * Destructor.
	    */
	   virtual ~mnslp_ipfix_message(void);
	   
	   /**
	    * Get a new instance from the ipfix message
	    */
	   virtual mnslp_ipfix_message *new_instance() const;
	
	   /**
	    * Copy this IPFIX message into a new message
	    */
	   virtual mnslp_ipfix_message *copy() const;

	   /**
	    * Length in bytes of the IPFIX message
	    */
	   virtual size_t get_serialized_size(coding_t coding) const;
	
	   /**
	    * We say that a IPFIX message is ok whenever executing the output 
	   ...
	   /**
	    * Check if the IPFIX message given as parameter has the same definition.
	    */
	    ...
	    * Set the encode mode
	    */
	   void set_encode_mode(bool _encode_network);  
