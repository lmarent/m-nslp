/// ----------------------------------------*- mode: C++; -*--
/// @file netmate_ipfix_metering_config.h
/// The netmate_ipfix_metering_config class.
/// ----------------------------------------------------------
/// $Id: netmate_ipfix_metering_config.h 2558 2015-01-16 13:34:00 amarentes $
/// $HeadURL: https://./include/netmate_ipfix_metering_config.h $
// ===========================================================
//                      
...
//
// ===========================================================
#ifndef MNSLP__NETMATE_IPFIX_METERING_CONFIG_H
#define MNSLP__NETMATE_IPFIX_METERING_CONFIG_H
 ...
 **/
class netmate_ipfix_metering_config : public metering_config
{
	public:
		netmate_ipfix_metering_config();
		
		netmate_ipfix_metering_config(const netmate_ipfix_metering_config &rhs);
		
		~netmate_ipfix_metering_config();
		
		virtual netmate_ipfix_metering_config *copy() const;
...
#endif // MNSLP__NETMATE_IPFIX_METERING_CONFIG_H
