/// ----------------------------------------*- mode: C++; -*--
/// @file netmate_policy_action_mapping.h
/// The netmate_policy_action_mapping class.
/// ----------------------------------------------------------
/// $Id: netmate_policy_action_mapping.h 2558 2015-01-16 13:34:00 amarentes $
/// $HeadURL: https://./include/netmate_policy_action_mapping.h $
// ===========================================================
//                      
...
//
// ===========================================================
#ifndef MNSLP__NETMATE_POLICY_ACTION_MAPPING_H
#define MNSLP__NETMATE_POLICY_ACTION_MAPPING_H
 ...
 *
 */
class netmate_policy_action_mapping : public policy_action_mapping {
  ...
  public:
	...
	netmate_policy_action_mapping(const netmate_policy_action_mapping &rhs);
	
	virtual ~netmate_policy_action_mapping();
	
	virtual netmate_policy_action_mapping *copy() const;
