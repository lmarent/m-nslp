/*
 * Test the netmate_metering_config class.
 *
 * $Id: netmate_metering_config.cpp 1711 2015-01-24 8:58:00 amarentes $
 * $HeadURL: https://./test/netmate_metering_config.cpp $
 */
 ...
 */
class netmate_metering_config_test : public netmate_metering_config
{
  public:
  
	netmate_metering_config_test(): netmate_metering_config() { }
...
void NetmateMeteringConfigTest::general_test() 
{
	...
	netmate_metering_config *netmate2 = netmate->copy();
