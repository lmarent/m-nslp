/*
 * Test the netmate_ipfix_policy_action_mapping class.
 *
 * $Id: netmate_ipfix_policy_action_mapping.cpp 1711 2015-01-24 8:58:00 amarentes $
 * $HeadURL: https://./test/netmate_ipfix_policy_action_mapping.cpp $
 */
 ...
 */
class policy_action_mapping_test : public netmate_ipfix_policy_action_mapping 
{
  public:
  
	policy_action_mapping_test(): netmate_ipfix_policy_action_mapping() { }
...
class PolicyActionMappingTest : public CppUnit::TestFixture {
  ...
  private:
    ...
    netmate_ipfix_metering_config *netmate;
...
void PolicyActionMappingTest::setUp() {
	...
	netmate = new netmate_ipfix_metering_config();
...
void PolicyActionMappingTest::general_test() 
{
	...
	netmate_ipfix_policy_action_mapping * ptrActionMapping3 = 
						new netmate_ipfix_policy_action_mapping(*ptrActionMapping2);
